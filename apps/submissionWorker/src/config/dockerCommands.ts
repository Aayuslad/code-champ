...
export const dockerCommands: { [key: number]: string } = {
	...
	// 3: `echo "_CODE" | base64 -d | docker run --rm -i openjdk:latest sh -c 'cat > Main.java && javac Main.java && java Main'`,
	3: `echo "_CODE" | base64 -d | docker run --rm -i openjdk:latest sh -c 'javac -d . Main.java && java Main'`,
